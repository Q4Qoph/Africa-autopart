...
export default {
  ...
  demo_vin_title: 'Try a VIN',
  part_detail_loading: 'Loading part details…',
  part_detail_error: 'Failed to load part details.',
  part_detail_price: 'Price',
  part_detail_supplier: 'Supplier',
  part_detail_availability: 'Availability',
  part_detail_location: 'Location',
