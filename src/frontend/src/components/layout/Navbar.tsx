...
const supplierNavLinks = [
  { label: 'RFQ Inbox',   href: '/supplier/dashboard' },
  { label: 'My Offers',   href: '/supplier/dashboard' },
  ...
  return (
    <>
      ...
      <div className="fixed top-0 inset-x-0 z-50 flex flex-col">
        ...
        {/* ── Topbar — desktop only ── */}
        <div className="hidden md:flex items-center h-9 bg-[#07110A] dark:bg-[#07110A] light:bg-[#07110A] border-b border-[rgba(0,200,83,0.1)] px-6">
          <div className="max-w-[1260px] w-full mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-5">
              <a
                ...
                className="flex items-center gap-1.5 text-[rgba(255,255,255,0.55)] hover:text-[#00C853] text-[11px] font-mono transition-colors"
              >
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={toggleLang}
                className="flex items-center gap-1 text-[rgba(255,255,255,0.45)] hover:text-[rgba(255,255,255,0.8)] text-[11px] transition-colors"
              >
                    ...
                    >
                      ...
                      <div className="px-3 py-2.5 border-b border-[rgba(0,0,0,0.06)] dark:border-[rgba(255,255,255,0.06)]">
                        <p className="text-xs font-semibold text-[#07110A] dark:text-white">
                          {auth.role === UserRole.Supplier ? 'Supplier' : auth.role === UserRole.Admin ? 'Admin' : 'Customer'}
                        </p>
