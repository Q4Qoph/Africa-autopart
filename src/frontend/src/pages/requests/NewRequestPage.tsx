...
const fieldClass =
  'bg-[#162019] border-[rgba(255,255,255,0.08)] text-white placeholder:text-[#3D5942] focus:border-[#00C853] h-11'
const selectClass =
  'w-full h-11 px-3 rounded-lg bg-[#162019] border border-[rgba(255,255,255,0.08)] text-white focus:outline-none focus:border-[#00C853] text-sm'
      ...
      <main className="pt-[68px]">
        <div className="max-w-[860px] mx-auto px-6 py-12">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-extrabold text-white font-display">Request a Part</h1>
          </div>
            ...
            <Section title="Supporting Images" step="04">
              <label className="block cursor-pointer">
                ...
                <div className="border-2 border-dashed border-[rgba(0,200,83,0.25)] rounded-xl p-8 text-center hover:border-[#00C853] transition-colors">
                  ...
                  <p className="text-[#3D5942] text-xs mt-1">PNG, JPG supported</p>
                </div>
              </label>
...
function Section({ title, step, children }: { title: string; step: string; children: React.ReactNode }) {
  return (
    <div className="bg-[#111C14] border border-[rgba(0,200,83,0.12)] rounded-2xl p-6">
...
function Field({
  ...
  return (
    <div className={cn('space-y-1.5', className)}>
      <Label className="text-[#E8F0E9] text-sm">{label}</Label>
      {children}
