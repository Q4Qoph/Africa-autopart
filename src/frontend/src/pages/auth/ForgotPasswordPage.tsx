      ...
      <div className="w-full max-w-[400px]">
        {sent ? (
          <div className="text-center py-10">
            ...
            <h2 className="text-white text-2xl font-extrabold font-display mb-2">Check your inbox</h2>
          ...
          <>
            <div className="mb-8">
              <h1 className="text-3xl font-extrabold text-white font-display mb-2">Forgot password?</h1>
            ...
            <div className="mt-6 pt-6 border-t border-[rgba(255,255,255,0.06)] text-center">
              <Link to="/login" className="text-sm text-[#7A9A80] hover:text-[#00C853] transition-colors">
                Back to sign in
              </Link>
            </div>
          </>
